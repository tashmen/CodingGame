 ...
 * Created On: 4/24/2022 3:21:32 PM
*/
...
namespace GameSolution.Algorithms
{
    public class Space2d
    {
        ...
        public static Tuple<int, Point2d> FindCircleWithMaximumPoints(Point2d[] points, int radius)
        {
            ...
            for (int i = 0; i < numberOfPoints; i++)
            {
                ...
                if (currentAnswer.Item1 > maxPoint.Item1)
                {
                    maxPoint = new Tuple<int, Point2d>(currentAnswer.Item1, new Point2d(points[i].x + (int)(radius * Math.Cos(currentAnswer.Item2)), points[i].y + (int)(radius * Math.Sin(currentAnswer.Item2))));
                }
            }
            return maxPoint;
        }
